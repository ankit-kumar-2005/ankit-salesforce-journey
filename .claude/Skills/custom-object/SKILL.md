...
**❌ INCORRECT** — Will cause error: `Cannot set sharingModel to private on a CustomObject with a MasterDetail relationship field`
```xml
<CustomObject xmlns="http://soap.sforce.com/2006/04/metadata">
  <label>Order Line Item</label>
  <pluralLabel>Order Line Items</pluralLabel>
  <sharingModel>private</sharingModel>  <!-- WRONG: Object has a M-D field -->
...
**`<description>`**: Mandatory. Every object must contain a professional summary. If you have ticket no or Jira ID for which object is being created mention that also in Description
...
- [ ] Does this object have a Master-Detail relationship field?
    ...
    - If NO → `<sharingModel>` should be `private`
